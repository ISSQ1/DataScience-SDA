...
class TestFootballDictionaries(unittest.TestCase):
    ...
    def test_assignment_2(self):
        ...
        self.assertEqual(len(result), 3)  # 3 positions

        goalkeepers = result['GK']
        self.assertEqual(len(goalkeepers), 2)

        self.assertEqual(goalkeepers[0], {
            'caps': '',
            'club': 'Quilmes',
            'club_country': 'Argentina',
            'country': 'Argentina',
        ...
        self.assertEqual(len(midfielders), 8)
        self.assertEqual(midfielders[0], {
            'caps': '42',
    ...
    def test_assignment_3(self):
        ...
        self.assertEqual(set(result.keys()), expected_countries)

        # Argentina
        argentina = result['Argentina']
        self.assertEqual(len(argentina), 2)

        ar_goalkeepers = argentina['GK']
        ar_forwards = argentina['FW']
        self.assertEqual(len(ar_goalkeepers), 1)
        self.assertEqual(len(ar_forwards), 1)

        # Brazil

        brazil = result['Brazil']
        self.assertEqual(len(brazil), 1)  # Only midfielders

        br_midfielders = brazil['MF']
        self.assertEqual(len(br_midfielders), 6)

        self.assertEqual(br_midfielders[0], {
            'caps': '29',
            'club': 'Chelsea',
        ...
        self.assertEqual(br_midfielders[-1], {
            'caps': '5',
            'club': 'Chelsea',
            'club_country': 'England',
            'country': 'Brazil',
